...
class JobboleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for post_url in post_urls:
            yield Request(self,post_url,callback = self.parse_detail)
        ...
        if next_url:
            yield Request(self, post_url, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        praise_nums = response.xpath('//*[@id="112239votetotal"]/text()').extract_first() #点赞
        fav_nums = response.xpath('//*[@id="post-112219"]/div[3]/div[4]/span[2]/text()').extract()[0] #收藏
        ...
        if match_re:
            ...
            fav_nums = 0
        #评论
        comments_nums = response.xpath('//*[@id="post-112219"]/div[3]/div[4]/a/span/text()').extract()[0]
